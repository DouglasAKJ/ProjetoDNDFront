...
acrobaciaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/acrobaciaExp/${id}`, {
    headers:{
...
arcanismoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/arcanismoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atletismoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/atletismoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atuacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/atuacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
enganacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/enganacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
furtividadeExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/furtividadeExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
historiaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/historiaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intimidacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/intimidacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intuicaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/intuicaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
investigacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/investigacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
lidaranimaisExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/lidaranimaisExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
medicinaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/medicinaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
naturezaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/naturezaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
percepcaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/percepcaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
persuasaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/persuasaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
prestidigitacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/prestidigitacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
religiaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/religiaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sobrevivenciaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`http://localhost:8080/ficha/sobrevivenciaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
