...
raca.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/raca/${id}`, {
      headers:{
...
aparencia.addEventListener("change", async function(){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/aparencia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
idiomas.addEventListener("change", async function(){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/idiomas/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
background.addEventListener("change", async function(){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/background/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
carateristicas.addEventListener("change", async function(){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/caracteristicas/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
async function salvarCantrip(){
  ...
  const save = await fetch(`https://projeto-dnd.onrender.com/ficha/adicionaSpell/${id}`, {
         headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
async function excluiSpell(nome, desc, time, range, nivel, elementoHTML){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/deletaSpell/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
botaoVoltar.addEventListener("click", function(){
  ...
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/adicionaAtaque/${id}`, {
    headers: {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
  ...
  document.getElementById(`saveButton${index}`).addEventListener("click", async function () {
    ...
    const res = await fetch(`https://projeto-dnd.onrender.com/ficha/adicionaAtaque/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Accept': 'application/json',
        'Content-Type': 'application/json'
  ...
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/deletaAtaque/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
acrobaciaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profAcrobacia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
arcanismoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profArcanismo/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atletismoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profAtletismo/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atuacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profAtuacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
enganacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profEnganacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
furtividadeProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profFurtividade/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
historiaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profHistoria/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intimidacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profIntimidacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intuicaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profIntuicao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
investigacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profInvestigacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
lidaranimaisProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profLidarAnimais/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
medicinaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profMedicina/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
naturezaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profNatureza/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
percepcaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profPercepcao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
persuasaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profPersuasao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
prestidigitacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profPrestidigitacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
religiaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profReligiao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sobrevivenciaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profSobrevivencia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
forcaCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profForca/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
dexCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profDestreza/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profInteligencia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
consCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profCons/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sabCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profSabedoria/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
carCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://projeto-dnd.onrender.com/ficha/profCarisma/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
classe.addEventListener("change", async function(){
  fetch(`https://projeto-dnd.onrender.com/ficha/${id}`,
    {
      headers:
      {
      'Authorization': `Bearer ${token}`,
...
classeArmadura.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraCA/${id}`,
    {
      headers:
      {
      'Authorization': `Bearer ${token}`,
...
deslocamento.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraDeslocamento/${id}`,
    {
      headers:
      {
      'Authorization': `Bearer ${token}`,
...
nivel.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/${id}`,
    {
      headers: {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
cdMagia.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraCD/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
hpAtual.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraHp/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
hpMax.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraHpMax/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
hpTemp.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraHpTemp/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
dano.addEventListener("click", async function(){
  ...
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/dano/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
cura.addEventListener("click", async function(){
  ...
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/cura/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
document.addEventListener("DOMContentLoaded", async function(){
  ...
  const res = await fetch(`https://projeto-dnd.onrender.com/usuarios/returnUsuario`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
forcaAtributo.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraForca/${id}`, {
      headers: {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
dexAtributo.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraDex/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
consAtributo.addEventListener("change", async function(){
 const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraCons/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intAtributo.addEventListener("change", async function(){
  const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraInteligencia/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sabAtributo.addEventListener("change", async function(){
 const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraSab/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
carismaAtributo.addEventListener("change", async function(){
 const response = await fetch(`https://projeto-dnd.onrender.com/ficha/alteraCarisma/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
