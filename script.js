...
acrobaciaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/acrobaciaExp/${id}`, {
    headers:{
...
arcanismoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/arcanismoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atletismoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/atletismoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atuacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/atuacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
enganacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/enganacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
furtividadeExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/furtividadeExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
historiaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/historiaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intimidacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/intimidacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intuicaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/intuicaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
investigacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/investigacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
lidaranimaisExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/lidaranimaisExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
medicinaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/medicinaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
naturezaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/naturezaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
percepcaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/percepcaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
persuasaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/persuasaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
prestidigitacaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/prestidigitacaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
religiaoExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/religiaoExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sobrevivenciaExp.addEventListener("change", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/sobrevivenciaExp/${id}`, {
    headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
raca.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/raca/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
aparencia.addEventListener("change", async function(){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/aparencia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
idiomas.addEventListener("change", async function(){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/idiomas/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
background.addEventListener("change", async function(){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/background/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
carateristicas.addEventListener("change", async function(){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/caracteristicas/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
async function salvarCantrip(){
  ...
  const save = await fetch(`https://67624d376d30.ngrok-free.app/ficha/adicionaSpell/${id}`, {
         headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
async function excluiSpell(nome, desc, time, range, nivel, elementoHTML){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/deletaSpell/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
botaoVoltar.addEventListener("click", function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/adicionaAtaque/${id}`, {
    headers: {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
  ...
  document.getElementById(`saveButton${index}`).addEventListener("click", async function () {
    ...
    const res = await fetch(`https://67624d376d30.ngrok-free.app/ficha/adicionaAtaque/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Accept': 'application/json',
        'Content-Type': 'application/json'
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/deletaAtaque/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
acrobaciaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profAcrobacia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
arcanismoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profArcanismo/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atletismoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profAtletismo/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
atuacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profAtuacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
enganacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profEnganacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
furtividadeProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profFurtividade/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
historiaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profHistoria/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intimidacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profIntimidacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intuicaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profIntuicao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
investigacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profInvestigacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
lidaranimaisProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profLidarAnimais/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
medicinaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profMedicina/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
naturezaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profNatureza/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
percepcaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profPercepcao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
persuasaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profPersuasao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
prestidigitacaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profPrestidigitacao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
religiaoProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profReligiao/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sobrevivenciaProf.addEventListener("change", async function(){
  if (this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profSobrevivencia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
forcaCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profForca/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
dexCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profDestreza/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profInteligencia/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
consCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profCons/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sabCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profSabedoria/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
carCheck.addEventListener("change", async function(){
  if(this.checked){
    const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/profCarisma/${id}`, {
      headers:{
      'Authorization': `Bearer ${token}`, 
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
classe.addEventListener("change", async function(){
  fetch(`https://67624d376d30.ngrok-free.app/ficha/${id}`,
    {
      headers:
      {
      'Authorization': `Bearer ${token}`,
...
classeArmadura.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraCA/${id}`,
    {
      headers:
      {
      'Authorization': `Bearer ${token}`,
...
deslocamento.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraDeslocamento/${id}`,
    {
      headers:
      {
      'Authorization': `Bearer ${token}`,
...
nivel.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/${id}`,
    {
      headers: {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
cdMagia.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraCD/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
hpAtual.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraHp/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
hpMax.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraHpMax/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
hpTemp.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraHpTemp/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
dano.addEventListener("click", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/dano/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
cura.addEventListener("click", async function(){
  ...
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/cura/${id}`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
document.addEventListener("DOMContentLoaded", async function(){
  ...
  const res = await fetch(`https://67624d376d30.ngrok-free.app/usuarios/returnUsuario`, {
    headers:
        {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
...
forcaAtributo.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraForca/${id}`, {
      headers: {
      'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
dexAtributo.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraDex/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
consAtributo.addEventListener("change", async function(){
 const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraCons/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
intAtributo.addEventListener("change", async function(){
  const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraInteligencia/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
sabAtributo.addEventListener("change", async function(){
 const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraSab/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
carismaAtributo.addEventListener("change", async function(){
 const response = await fetch(`https://67624d376d30.ngrok-free.app/ficha/alteraCarisma/${id}`, {
      headers: {
        'Authorization': `Bearer ${token}`,
      'Accept': 'application/json',
      'Content-Type': 'application/json'
