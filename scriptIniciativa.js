...
botaoLimpar.addEventListener("click", async function(){
    const response = await fetch("https://ae8716cea846.ngrok-free.app/iniciativa/deleta", {
        headers: {
...
document.addEventListener("DOMContentLoaded", async function(){
    const response2 = await fetch("https://ae8716cea846.ngrok-free.app/iniciativa", {
                headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        },
...
form.addEventListener("submit", async function(e){
            ...
            const response = await fetch("https://ae8716cea846.ngrok-free.app/iniciativa", {
                headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        },
    ...
    async function deletaId(id){
        const response = await fetch(`https://ae8716cea846.ngrok-free.app/iniciativa/deletaIniciativa/${id}`, {
            headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        },
    ...
    async function atualizarHP(id){
        ...
        await fetch(`https://ae8716cea846.ngrok-free.app/iniciativa/${id}`, {
            headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        },
